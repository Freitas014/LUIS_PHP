<?php
    ...
    $usuario = "root";  // Nome de usuário de banco
    $senha = "";    // Senha do banco
    $bancodedaos = "empresa"; // Nome do banco de dados
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        while($linha = mysqli_fetch_assoc($result)) { // mysqli_fetch_assoc não deixa trazer índice repetido
            echo "ID: <br>" . $linha["id_cliente"] . " - Nome: " . $linha["nome"] . " - Email: " . $linha["email"] . "<br>";}
        } else {
            echo "Nehum resultado encontrado.";}
